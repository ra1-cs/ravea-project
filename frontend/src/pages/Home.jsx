  ...
  return (
    <div className="home-luxury">
      ...
      <section className="editorial-hero">
        <div className="editorial-left">
          ...
          <div className="hero-buttons">
            ...
            <Link to="/recommendations" className="champagne-btn">
              Find My Match
            </Link>
          </div>
        </div>
      ...
      <section className="collection-panels">
        <Link to="/products?category=Makeup" className="panel makeup-panel">
          <span>Makeup</span>
          <h2>Color that speaks luxury.</h2>
        </Link>

        <Link to="/products?category=Skincare" className="panel skincare-panel">
          <span>Skincare</span>
          <h2>Care designed around your skin.</h2>
        </Link>

        <Link to="/products?category=Tools" className="panel tools-panel">
          <span>Tools</span>
